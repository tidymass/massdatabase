...
# library(rvest)
# result <-
#   rvest::read_html("https://gnps.ucsd.edu/ProteoSAFe/gnpslibraryspectrum.jsp?SpectrumID=CCMSLIB00000001547#%7B%7D")
#
# result %>%
#   html_text()
#
...
#
# result %>%
#   rvest::html_node(".mainform td") %>%
#   rvest::html_text(trim = TRUE)
#
#
# result %>%
#   rvest::html_element(".sched th") %>%
#   rvest::html_text(trim = TRUE)
#
#
# result %>%
